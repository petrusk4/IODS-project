...
identical(colnames(math), colnames(por))
...
gtsummary::tbl_regression(m, exp = T)
```
...
m %>% gtsummary::tbl_regression(exp = T)
...
alc <- mutate(alc, prediction = probabilities > .5)
...
g <- ggplot(alc, aes(x = probabilities, y = high_use))
