...
This dataset also contains a variable called `gender`. It could be hypothesized that attitude, learning strategies and/or exam points differ between the genders. Perhaps `gender` modifies the relationship between learning strategies and exam points. 
